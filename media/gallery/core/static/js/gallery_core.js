window.gallery_core = Object({
    settings: {
        form_upload_url: "core/api/upload/get_form/",
        upload_url: "core/api/upload/post_upload/",
        upload_thumb_url: "core/api/upload/post_upload_thumbs/",
        upload_lt_url: "core/upload/lighttable/",
        review_panel_url: "/dashboard/user/core/api/upload/review_panel/",
        publish_url: "core/api/upload/publish/",
        get_collection_url: "/dashboard/user/core/api/get/items/",
        view_count_url: "/dashboard/user/core/api/view_counter/item",
        share_count_url: "/dashboard/user/core/api/share_counter/item",
        ...
        sidebar_panel: "#nav",
        viewer_modal: "#core-viewer",
        viewer_title: "#title-span",
        viewer_info: "#core-span",
        viewer_hdr: ".core-modal-header",
        like_btn: "#btn-like",
        like_url: "/dashboard/user/core/api/fav/item/",
        like_q_url: "/dashboard/user/core/api/get/fav/item/",
...
/** loadPlugin: Loads a plugin from the assets/plugins/ directory from the core plugin the file specified: The plugin must include a gallery_plugin.json that describes the css and js files to be loaded. **/
...
//             $(gallery_core.settings.like_btn).attr("disabled","");
     ...
     /** This function _renders_ a core card's metadata: **/
...
//                     console.warn(this.nav);
    ...
    /** Recasting: will publish to the stream, "share to ply", and create a 'recast' metric: **/
     ...
     /** This function launches a core from a card: **/
