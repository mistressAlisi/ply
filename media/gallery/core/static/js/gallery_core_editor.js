window.gallery_core_editor = Object({
    settings: {
        ...
        invis_url: "/dashboard/user/core/api/toggle/invis",
        copymove_url:"/dashboard/user/core/api/copymove/form",
        copymove_exec_url:"/dashboard/user/core/api/copymove/form/exec",
        copymove_form: "#copy_move_form",
        remove_url:"/dashboard/user/core/api/remove/item/form",
        remove_exec_url:"/dashboard/user/core/api/remove/item/form/exec",
        remove_form: "#remove_form",
        set_url:"/dashboard/user/core/api/settings/item/form",
        set_exec_url:"/dashboard/user/core/api/settings/item/form/exec",
        set_form: "#settings_form",
        meta_url: "/dashboard/user/core/api/metadata/item",
        det_url:"/dashboard/user/core/api/details/item/form",
        det_exec_url:"/dashboard/user/core/api/details/item/form/exec",
