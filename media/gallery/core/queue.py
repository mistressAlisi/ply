...
class GalleryPublisher(Thread):
    """This is a very basic GalleryPublisher object that will connect to the AMQP server and queue jobs for publishing and processing.
    It is based on the PIKA example for Async publishers and is meant to run long-term.
    """
    EXCHANGE = 'message'
    EXCHANGE_TYPE = ExchangeType.topic
    PUBLISH_INTERVAL = 1
    QUEUE = 'ply'
    ROUTING_KEY = 'core.publish'
    LOGGER = False
    ...
    def publish_into_queue(self,message,app_id="ply_gallery",content_type="application/json",content_hdr={}):
