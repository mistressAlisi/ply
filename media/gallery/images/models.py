...
class GalleryImagesSettings(models.Model):
    ...
    enabled_filetypes = models.ManyToManyField(GalleryImagesFileTypes,verbose_name="Enabled Filetypes",help_text="Select which File types are allowed in this Gallery.")
    def __str__(self):
