...
class review_form(forms.Form):
    ...
    publish_category = forms.ModelChoiceField(queryset=Category.objects.all().order_by('discipline'),widget=Select(attrs={"id":"review-publish_category"}),label="Category:")
