...
class Forge_Form(ModelForm):
    class Meta:
        ...
        fields = ["max_filesize","enable_exif","min_dpi","rescaler_enabled","enabled_filetypes","rescaler_factor","rescaler_target_format","rescaler_target_quality","downloads_enabled","community"]
