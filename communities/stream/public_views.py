...
from communities.stream.forms import StreamSettingsForm
from communities.stream.models import Stream,StreamMessage,MessagesPerStreamView,StreamMessageKeywords
...
def view_message(request,muuid):
    ...
    if (message.type == "application/ply.stream.core"):
        """
        Get collection / Item data (get a thumbnail), this is a core card:
        """
