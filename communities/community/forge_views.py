...
def community_staff(request):
    ...
    return render(
        request, "dashboard/community_admin/community_staff/index.html", context
    )
...
def community_admins(request):
    ...
    return render(
        request, "dashboard/community_admin/community_admins/index.html", context
    )
...
def default_profile_editor(request):
    ...
    context = {
        ...
        "stats": stats,
        "dynapage_template": profilePage.dynapage.template.filename,
        "dynapage_page_name": f"Default Community Profile",
...
def sidebar_menu_editor(request):
    ...
    return render(request, "dashboard/community_admin/menus/index.html", context)
