...
class GalleryItemHit(models.Model):
    ...
    profile = models.ForeignKey(Profile,verbose_name='Item Viewed by Profile',on_delete=models.CASCADE)
    group = models.ForeignKey(Group,verbose_name = "Item viewed by member of group",on_delete=models.CASCADE)
    community = models.ForeignKey(Community,verbose_name = "Community",on_delete=models.RESTRICT)
    def __str__(self):
        return f"Gallery Item Hit: {self.item.uuid} for: {self.profile.uuid}"
