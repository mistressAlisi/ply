...
from django.forms import ModelForm,DateInput,Textarea,TextInput,Form,ClearableFileInput,Select,CheckboxInput,HiddenInput,PasswordInput
from datetime import datetime
from ply.toolkit import ratings
from gallery.toolkit import settings
from gallery.models import GalleryCollection,GalleryCollectionPermission
OPERATIONS = [
