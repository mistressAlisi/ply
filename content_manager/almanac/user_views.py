...
from content_manager.almanac.models import AlmanacMenuCategory, AlmanacPage,AlmanacPageText
from core.dynapages.models import Templates
from content_manager.almanac.forms import NewPageForm,NewCategoryForm,AddPageForm
