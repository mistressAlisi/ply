...
class EmojiKeyboard {
            ...
            this.stickyObserver = new IntersectionObserver(entries => {
                entries.forEach(entry => {
                    ...
                    if (scrollPos >= 1) {
                        ...
                        const list = window.document.getElementById("emojikb-leftlist");
    ...
    toggle_window() {
        let kb = window.document.getElementById("emojikb-maindiv");
        if (!kb) {
    ...
    create_keyboard(document) {
        ...
        if (this.resizable) {
            ...
            main_div.addEventListener("mousedown", (e) => {
                if (e.offsetX < 4) {
                    ...
                    window.document.addEventListener("mousemove", f, false);
                }
            }, false);
            window.document.addEventListener("mouseup", () => {
                window.document.removeEventListener("mousemove", f, false);
            }, false);
        }
        // search div
        let search_div = window.document.createElement("div");
        search_div.id = "emojikb-searchdiv";
        // let s_div = window.document.createElement("div");
        let s_area = window.document.createElement("input");
        ...
        // categories list
        let list_div = window.document.createElement("div");
        list_div.id = "emojikb-leftlist";
        let div3 = window.document.createElement("div");
        div3.id = "emojikb-div3";
        // emojis list
        let emojis_div = window.document.createElement("div");
        ...
        // emoji info
        let info_div = window.document.createElement("div");
        info_div.id = "emojikb-info";
        let info_icon = window.document.createElement("img");
        info_icon.id = "emojikb-info-icon";
        info_icon.src = first_emoji.url;
        let info_name = window.document.createElement("div");
        ...
        window.document.documentElement.appendChild(main_div);
    }
